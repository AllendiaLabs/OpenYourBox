...
**Rationale**: Clarification Session 2026-08-26 (Option B); FR-002 / FR-002a / FR-002b / FR-017.
...
## Decision 4: Snapshot-based undo via JUCE `UndoManager`
...
## Decision 5: What is / is not on the undo stack
...
## Decision 6: Preset load is one undoable step (preserves current/dirty)
...
## Decision 7: Audio-safe apply path
...
## Decision 8: Memory bound for undo with weights
...
## Decision 9: Scope exclusions remain firm
